 ...
 */
final class Version20200301144738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reset_token VARCHAR(255) DEFAULT NULL, DROP api_token, CHANGE roles roles JSON NOT NULL, CHANGE profil_picture profil_picture VARCHAR(255) DEFAULT NULL, CHANGE skill skill LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
